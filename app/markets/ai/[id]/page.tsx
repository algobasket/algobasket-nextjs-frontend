...
export default function AIProductPage() {
  ...
  const product = aiProducts.find((p) => p.id === parseInt(params.id as string, 10))
  ...
  if (!product) {
    return (
      <div className="text-center py-5">
        ...
        <Link href="/markets/ai" className="btn btn-primary">Back to AI Market</Link>
      </div>
    )
  }
    ...
    <>
      <nav aria-label="breadcrumb" className="mb-4">
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item"><Link href="/markets/ai" className="text-decoration-none">AI Market</Link></li>
            ...
            <div className="card border-0 shadow-sm">
              <div className="card-body p-4">
                ...
                <div className="mt-4 p-3 bg-light rounded">
                  <strong>Important:</strong> This is an AI product. Purchase includes {supportMonths} months of support and future updates.
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === 'support' && (
            <div className="card border-0 shadow-sm">
              <div className="card-body p-4">
                ...
                <p className="text-muted mb-0">AI products include {supportMonths} months of support. Contact us through the Algobasket support portal or email support@algobasket.com.</p>
              </div>
            </div>
          )}
        </div>
