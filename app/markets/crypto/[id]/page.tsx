...
import { cryptoProducts } from '../data'

export default function CryptoProductPage() {
  const params = useParams()
  const product = cryptoProducts.find((p) => p.id === parseInt(params.id as string, 10))
  ...
  if (!product) {
    return (
      <div className="text-center py-5">
        ...
        <Link href="/markets/crypto" className="btn btn-primary">Back to Crypto Market</Link>
      </div>
    )
  }
    ...
    <>
      <nav aria-label="breadcrumb" className="mb-4">
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item"><Link href="/markets/crypto" className="text-decoration-none">Crypto Market</Link></li>
            ...
            <div className="card border-0 shadow-sm">
              <div className="card-body p-4">
                ...
                <div className="mt-4 p-3 bg-light rounded">
                  <strong>Important:</strong> This is a crypto product. Purchase includes {supportMonths} months of support and future updates.
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === 'support' && (
            <div className="card border-0 shadow-sm">
              <div className="card-body p-4">
                ...
                <p className="text-muted mb-0">Crypto products include {supportMonths} months of support. Contact us through the Algobasket support portal or email support@algobasket.com.</p>
              </div>
            </div>
          )}
        </div>
